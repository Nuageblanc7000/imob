 ...
 */
final class Version20221123215327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, price NUMERIC(20, 2) NOT NULL, bedroom INT NOT NULL, bathroom INT DEFAULT NULL, year DATE DEFAULT NULL, floor INT DEFAULT NULL, building_condition VARCHAR(255) DEFAULT NULL, living_area INT DEFAULT NULL, kitchen_type VARCHAR(255) DEFAULT NULL, energy_class VARCHAR(100) DEFAULT NULL, number_class VARCHAR(255) DEFAULT NULL, INDEX IDX_8BF21CDE12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
